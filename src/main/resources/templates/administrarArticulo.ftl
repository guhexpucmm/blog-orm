                ...
                <#if estaLogueado == true>
                    <div class="btn-group" role="group" aria-label="...">
                        <button type="button" class="btn btn-success"
                                onclick="location.href = '/valoracion/?valoracion=true&usuario=${usuarioLogueado.getId()}&articulo=${articuloSeleccionado.getId()}'">
                            <span class="glyphicon glyphicon-thumbs-up"></span>Me gusta!<span
                                class="badge">${valoracionesPositivas}</span>
                        </button>
                        <button type="button" class="btn btn-danger"
                                onclick="location.href = '/valoracion/?valoracion=false&usuario=${usuarioLogueado.getId()}&articulo=${articuloSeleccionado.getId()}'">
